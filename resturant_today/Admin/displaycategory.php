...
<header class="header-top navbar fixed-top">
            ...
            <?php
                ...
                $sql = "SELECT catg_id, category FROM category_type";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fs-bars"></i> View Category</h3>
                                <div class="tools">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <div id="home" class="tab-pane fade in active" style="padding:5px">
										...
										<input type="text" placeholder="Search Category" style="width:100%; padding:5px">
										</div>
                                    	<table cellpadding="0px" cellspacing="0px" border="1" style="text-align:center; width:100%">


                                                                <tbody><tr>
                                                                <td style="background-color:#d1d1d1; font-weight:bold"></td>
                                                                <td style="background-color:#d1d1d1; font-weight:bold">Category</td>
                                                                </tr>
                                                                <?php
                                                                if ($result->num_rows > 0) {
                                                                  // output data of each row
                                                                  while($row = $result->fetch_assoc()) {
                                                                      ...
                                                                      . $row["catg_id"]. "' /></span> <input type='checkbox'></td>";
...
<!--
                                        ...
                                        <div align="center" style="margin:5px 0">
                                            <button id="redbtn">DELETE</button>
                                            <button id="redbtn">RESET</button>
                                        </div>
                                    </div>
                                </div>
