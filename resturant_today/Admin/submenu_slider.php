                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fs-bars"></i> View Location</h3>
                                <div class="tools">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <div id="home" class="tab-pane fade in active" style="padding:5px">
										...
										<input type="text" placeholder="Search Location" style="width:100%; padding:5px">
										</div>
                                    	<table cellpadding="0px" cellspacing="0px" border="1" style="text-align:center; width:100%">
                                                                ...
                                                                <td style="background-color:#d1d1d1; font-weight:bold">Location</td>
                                                                </tr>
                                                                <?php
                                                                if ($result->num_rows > 0) {
                                                                  // output data of each row
